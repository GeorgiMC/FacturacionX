...
namespace CapaLogica
{
    ...
    {
        public List<DevolucionDatos> SeleccionarDevoluciones(string cia)
        {
            List<DevolucionDatos> lista = new List<DevolucionDatos>();
            DataSet ds = DevolucionDatos.SeleccionarTodos(cia);

            foreach (DataRow row in ds.Tables[0].Rows)
            {
                DevolucionDatos obj = new DevolucionDatos();
                ...
                obj.factura = row["factura"].ToString();
